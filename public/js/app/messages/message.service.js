...
export var MessageService = (function () {
    ...
    MessageService.prototype.addMessage = function (message) {
        ...
        return this.http.post("http://angular2-deploying.herokuapp.com/message" + token, body, { headers: headers })
    ...
    MessageService.prototype.getMessages = function () {
        var _this = this;
        return this.http.get('http://angular2-deploying.herokuapp.com/message')
            .map(function (response) {
    ...
    MessageService.prototype.updateMessage = function (message) {
        ...
        var token = localStorage.getItem('token')
            ? "?token=" + localStorage.getItem('token') : '';
        return this.http.patch("http://angular2-deploying.herokuapp.com/message/" + (message.messageId + token), body, { headers: headers })
    ...
    MessageService.prototype.deleteMessage = function (message) {
        ...
        var token = localStorage.getItem('token')
            ? "?token=" + localStorage.getItem('token') : '';
        return this.http.delete("http://angular2-deploying.herokuapp.com/message/" + (message.messageId + token))
            .map(function (response) { return response.json(); })
            .catch(function (error) {
            _this.errorService.handleError(error.json());
            return Observable.throw(error.json());
