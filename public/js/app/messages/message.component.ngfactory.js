...
var _View_MessageComponent0 = (function (_super) {
    ...
    _View_MessageComponent0.prototype.createInternal = function (rootSelector) {
        ...
        this._TemplateRef_10_5 = new import15.TemplateRef_(this._appEl_10, viewFactory_MessageComponent1);
    ...
    _View_MessageComponent0.prototype.injectorGetInternal = function (token, requestNodeIndex, notFoundResult) {
        ...
        if (((token === import11.NgStyle) && ((0 <= requestNodeIndex) && (requestNodeIndex <= 12)))) {
            return this._NgStyle_0_3;
        }
        return notFoundResult;
    };
    _View_MessageComponent0.prototype.detectChangesInternal = function (throwOnChange) {
        var currVal_1 = this._map_0(this.context.color);
        ...
        var currVal_4 = this.context.belongsToUser();
    ...
    _View_MessageComponent0.prototype._handle_mouseenter_0_0 = function ($event) {
        this.markPathToRootAsCheckOnce();
        var pd_0 = ((this.context.color = 'green') !== false);
        return (true && pd_0);
    };
...
export function viewFactory_MessageComponent0(viewUtils, parentInjector, declarationEl) {
    if ((renderType_MessageComponent === null)) {
        (renderType_MessageComponent = viewUtils.createRenderComponentType('C:/Users/Tippy/Desktop/Projects/Mean2D3/assets/app/messages/message.component.html', 0, import9.ViewEncapsulation.Emulated, styles_MessageComponent, {}));
    }
