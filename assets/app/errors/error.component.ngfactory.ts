...
class _View_ErrorComponent0 extends import1.AppView<import3.ErrorComponent> {
  ...
  createInternal(rootSelector:string):import2.AppElement {
    ...
    this.renderer.setElementAttribute(this._el_0,'style','position: fixed');
    ...
    this._el_16 = this.renderer.createElement(this._el_8,'h4',(null as any));
    this.renderer.setElementAttribute(this._el_16,'class','modal-title');
    ...
    this.renderer.setElementAttribute(this._el_20,'class','modal-body');
    ...
    this.renderer.setElementAttribute(this._el_26,'class','modal-footer');
    this._text_27 = this.renderer.createText(this._el_26,'\n                ',(null as any));
    this._el_28 = this.renderer.createElement(this._el_26,'button',(null as any));
    this.renderer.setElementAttribute(this._el_28,'class','btn btn-default');
  ...
  injectorGetInternal(token:any,requestNodeIndex:number,notFoundResult:any):any {
    ...
    if (((token === import11.NgStyle) && ((2 <= requestNodeIndex) && (requestNodeIndex <= 33)))) { return this._NgStyle_2_3; }
    return notFoundResult;
  }
  detectChangesInternal(throwOnChange:boolean):void {
...
export function viewFactory_ErrorComponent0(viewUtils:import4.ViewUtils,parentInjector:import5.Injector,declarationEl:import2.AppElement):import1.AppView<import3.ErrorComponent> {
  if ((renderType_ErrorComponent === (null as any))) { (renderType_ErrorComponent = viewUtils.createRenderComponentType('C:/Users/Tippy/Desktop/Projects/MEAN2D3/assets/app/errors/error.component.html',0,import9.ViewEncapsulation.Emulated,styles_ErrorComponent,{})); }
